...
/***/ function(module, exports, __webpack_require__) {
	...
	var TableModel = __webpack_require__(35);
	var TableController = __webpack_require__(36);
	var TableView = __webpack_require__(37);
	var initTemplate = __webpack_require__(40);
	var popUpTemplate = __webpack_require__(41);
	var rowTemplate = __webpack_require__(42);
	var modalTemplate = __webpack_require__(43);
...
/***/ function(module, exports) {
	...
	module.exports = "<% _.each(data['config'],function(value,key){ %>\r\n<tr class=\"table__row\">\r\n  <td class=\"table__cell\"><a href=\"\" class=\"table__port\"><%=data['config'][key].localPort%></a></td>\r\n  <td class=\"table__cell\"><input type=\"url\" class=\"table__input table__input--remote\" value=\"<%=data['config'][key].remoteHost%>\" required pattern=\"https?://.+\"></td>\r\n  <td class=\"table__cell\">\r\n    <select class=\"form-control table__mode\">\r\n      <%_.each(data['mods'], function(mode, index){%>\r\n      <%if(mode === data['config'][key].mode.toUpperCase()){%>\r\n      <option selected><%=mode%></option>\r\n      <%} else {%>\r\n      <option><%=mode%></option>\r\n      <%}%>\r\n      <%})%>\r\n    </select>\r\n  </td>\r\n  <%if(data['config'][key].mode.toLowerCase() !== 'flow_emulator'){%>\r\n  <td class=\"table__cell\">\r\n    <input type=\"text\" class=\"table__input table__input--step\" value=\"1\" style=\"display: none\">\r\n    <button type=\"button\" class=\"btn btn-success button button__update button__update--step\" style=\"display:none\">Set step</button>\r\n  </td>\r\n  <td class=\"table__cell\">\r\n    <button type=\"button\" class=\"btn btn-success button button__update button__update--config\">Update</button>\r\n  </td>\r\n  <%} else {%>\r\n  <td class=\"table__cell\">\r\n    <input type=\"text\" class=\"table__input table__input--step\" value=\"<%=data['config'][key].step%>\">\r\n    <button type=\"button\" class=\"btn btn-success button button__update button__update--step\">Set step</button>\r\n  </td>\r\n  <td class=\"table__cell\">\r\n    <button type=\"button\" class=\"btn btn-success button button__update button__update--config\">Update</button>\r\n  </td>\r\n<%}%>\r\n  <td class=\"table__cell\">\r\n    <button type=\"button\" class=\"btn btn-danger button button__remove\" data-toggle=\"modal\" data-target=\"#deleteModal\">Delete</button>\r\n  </td>\r\n</tr>\r\n<%})%>";

/***/ },
/* 41 */
/***/ function(module, exports) {

	module.exports = "<div class=\"popup popup--<%=update.status%>\">\r\n  <div class=\"popup-icon popup-icon--<%=update.status%> popup--<%=update.status%>-darker\">\r\n  <% if (update.status === \"error\") {%>\r\n    <i class=\"glyphicon glyphicon-remove popup-icon-size\"></i>\r\n  <%} else if (update.status === \"warning\") {%>\r\n  <i class=\"glyphicon glyphicon-warning-sign popup-icon-size\"></i>\r\n  <%} else if (update.status === \"success\") {%>\r\n  <i class=\"glyphicon glyphicon-ok popup-icon-size\"></i>\r\n  <%}%>\r\n  </div>\r\n  <div class=\"popup-body\">\r\n    <p class=\"popup__title\"><%=update.statusText%></p>\r\n  </div>\r\n</div>";

/***/ },
/* 42 */
/***/ function(module, exports) {

	module.exports = "<% _.each(data['port'],function(value,key){ %>\r\n<tr class=\"table__row\">\r\n  <td class=\"table__cell\"><a href=\"#\" class=\"table__port\"><%=value%></a></td>\r\n  <td class=\"table__cell\"><input type=\"url\" class=\"table__input table__input--remote\" value=\"\"></td>\r\n  <td class=\"table__cell\">\r\n    <select class=\"form-control table__mode\">\r\n      <%_.each(data['mods'], function(mode, index){%>\r\n      <option><%=mode%></option>\r\n      <%})%>\r\n    </select>\r\n  </td>\r\n  <td class=\"table__cell\">\r\n    <input type=\"text\" class=\"table__input table__input--step\" value=\"1\" style=\"display:none\">\r\n  </td>\r\n  <td class=\"table__cell\">\r\n    <button type=\"button\" class=\"btn btn-success button button__update\" disabled>Update</button>\r\n  </td>\r\n  <td class=\"table__cell\">\r\n    <button type=\"button\" class=\"btn btn-success button button__send\">Send</button>\r\n  </td>\r\n  <td class=\"table__cell\">\r\n    <button type=\"button\" class=\"btn btn-danger button button__remove\">Delete</button>\r\n  </td>\r\n</tr>\r\n<%})%>";

/***/ },
/* 43 */
/***/ function(module, exports) {

	module.exports = "<div id=\"myModal\" class=\"modal fade\" role=\"dialog\">\r\n  <div class=\"modal-dialog modal-lg\">\r\n\r\n    <!-- Modal content-->\r\n    <div class=\"modal-content modal__content\">\r\n      <div class=\"modal-header\">\r\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\">&times;</button>\r\n        <h4 class=\"modal-title modal__title\">Add new App_IP:port</h4>\r\n      </div>\r\n      <div class=\"modal-body\">\r\n        <div class=\"row\">\r\n          <p class=\"col col-lg-3 col-md-3 col-xs-3\">Port</p>\r\n          <input type=\"text\" class=\"modal__input--port col col-lg-8 col-md-8 col-xs-8\">\r\n        </div>\r\n\r\n        <div class=\"row\">\r\n          <p class=\"col col-lg-3 col-md-3 col-xs-3\">Remote</p>\r\n          <input type=\"url\" class=\"modal__input--remote col col-lg-8 col-md-8 col-xs-8\" required pattern=\"https?://.+\">\r\n        </div>\r\n\r\n        <div class=\"row\">\r\n          <p class=\"col col-lg-3 col-md-3 col-xs-3\">Mode</p>\r\n          <select class=\"form-control table__mode table__mode--modal col col-lg-8 col-md-8 col-xs-8\">\r\n            <%_.each(mods, function(mode, index){%>\r\n            <option><%=mode%></option>\r\n            <%})%>\r\n          </select>\r\n        </div>\r\n      </div>\r\n      <div class=\"modal-footer\">\r\n        <button type=\"button\" class=\"btn btn-default button\" data-dismiss=\"modal\">Close</button>\r\n        <button type=\"button\" class=\"btn btn-success  button modal__button--submit\">Submit</button>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n";
